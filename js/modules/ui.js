...
export async function initSectionCollapse() {
  const sections = document.querySelectorAll("section:not(#hero)");
  if (!sections.length) return;

  const [eyeIconOpen, eyeIconClosed] = await Promise.all([
    getSvg("assets/svgs/eye-open.svg"),
    getSvg("assets/svgs/eye-closed.svg")
  ]);
